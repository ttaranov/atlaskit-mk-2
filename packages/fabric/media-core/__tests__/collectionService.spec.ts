    ...
    const response = collectionService
      ...
      .then(response => {
        ...
        expect(request.url).toBe(
          `${serviceHost}/collection/${collectionName}/items?collection=${
            collectionName
          }&limit=${DEFAULT_COLLECTION_PAGE_SIZE}&${authParams}`,
        );
      });
      ...
      .then(response => {
        ...
        expect(request.url).toBe(
          `${serviceHost}/collection/${collectionName}/items?collection=${
            ...
            `inclusiveStartKey=${inclusiveStartKey}&sortDirection=${
              sortDirection
            }&details=${details}&${authParams}`,
        );
      });
