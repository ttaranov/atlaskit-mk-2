...
import { p, table, tr, th, td, doc, strong, mention, ol, li } from './_schema-builder';
    ...
    it('should preserve mentions correctly', () => {
      expect(markdownSerializer.serialize(
        table(
          table(
            tr(th({})(p('h1')), th({})(p('h2')), th({})(p('h3'))),
            tr(td({})(p('c11', mention({ text: 'Testing Testing', id: 'test' }))), td({})(p('c12')), td({})(p('c13'))),
          )
        )
      )).to.eq('| h1 | h2 | h3 |\n| --- | --- | --- |\n| c11@test | c12 | c13 |\n');
    });
    ...
    it('should separate content of list with space', () => {
      expect(markdownSerializer.serialize(
        table(
          table(
            tr(th({})(p('h1')), th({})(p('h2')), th({})(p('h3'))),
            tr(td({})(ol(li(p('l1')), li(p('l2')))), td({})(p('c12')), td({})(p('c13'))),
          )
        )
      )).to.eq('| h1 | h2 | h3 |\n| --- | --- | --- |\n| l1 l2 | c12 | c13 |\n');
    });
