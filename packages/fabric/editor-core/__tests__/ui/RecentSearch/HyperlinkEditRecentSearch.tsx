...
describe('@atlaskit/editor-core/ui/HyperlinkEditRecentSearch', () => {
  ...
  it('should show recent items by default', async () => {
    ...
    expect(recentSearch.find(RecentItem).at(0).prop('item')).toHaveProperty('name', 'recent item 1');
    hyperlinkEdit.unmount();
  });
  ...
  it('should allow clicking on a link form the search results to insert it', async () => {
    ...
    expect(editorView.state.doc).toEqualDocument(doc(paragraph(link({ href: 'http://recent1-url.com' })('recent item 1'))));
    hyperlinkEdit.unmount();
  });
  ...
  it('should allow inserting an arbitrary link', async () => {
    ...
    expect(editorView.state.doc).toEqualDocument(doc(paragraph(link({ href: 'http://example.com' })('example.com'))));
    hyperlinkEdit.unmount();
  });
  ...
  it('should allow selecting a link from search results with the keyboard and inserting it by pressing return', async () => {
    ...
    expect(editorView.state.doc).toEqualDocument(doc(paragraph(link({ href: 'http://recent2-url.com' })('recent item 2'))));
    hyperlinkEdit.unmount();
  });
  ...
  it('should allow inserting a link from a text selection', async () => {
    ...
    expect(editorView.state.doc).toEqualDocument(doc(paragraph(link({ href: 'http://recent1-url.com' })('Page'))));
    hyperlinkEdit.unmount();
  });
});
