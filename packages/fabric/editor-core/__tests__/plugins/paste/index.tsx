...
import { code_block, doc, p, code, makeEditor, dispatchPasteEvent, isMobileBrowser } from '@atlaskit/editor-test-helpers';
  ...
  describe('paste plugins', () => {
    ...
    describe('handlePaste', () => {
      it('should not create paragraph when plain text is copied in code-block', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(code_block()('plain text')));
      });
      ...
      it('should create code-block for multiple lines of code copied', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(code_block()('code line 1\ncode line 2')));
      });
      ...
      it('should create code mark for single lines of code copied', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(p(code('code single line'))));
      });
      ...
      it('should create code block for font-family monospace css', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(code_block()('Code :D')));
      });
