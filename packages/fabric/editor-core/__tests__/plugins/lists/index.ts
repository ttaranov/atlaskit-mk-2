...
import { makeEditor, sendKeyToPm, doc, h1, ol, ul, li, p, panel } from '@atlaskit/editor-test-helpers';
  ...
  describe('keymap', () => {
    ...
    describe('when hit enter', () => {
      it('should split list item', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(ul(li(p('text')), li(p()))));
      });
    });
    ...
    describe('when hit Tab', () => {
      it('should call indent analytics event', () => {
        ...
        expect(trackEvent).toHaveBeenCalledWith('atlassian.editor.format.list.indent.keyboard');
      });
    });
    ...
    describe('when hit Shift-Tab', () => {
      it('should call outdent analytics event', () => {
        ...
        expect(trackEvent).toHaveBeenCalledWith('atlassian.editor.format.list.outdent.keyboard');
      });
    });
      ...
      describe('when on a mac', () => {
        describe('when hit Cmd-Alt-7', () => {
          it('should toggle ordered list', () => {
            ...
            expect(trackEvent).toHaveBeenCalledWith('atlassian.editor.format.list.numbered.keyboard');
          });
        });
        ...
        describe('when hit Cmd-Alt-8', () => {
          it('should toggle bullet list', () => {
            ...
            expect(trackEvent).toHaveBeenCalledWith('atlassian.editor.format.list.bullet.keyboard');
          });
        });
      });
    }
  ...
  describe('API', () => {
    ...
    describe('untoggling a list', () => {
      ...
      it('should untoggle empty paragraphs in a list', () => {
        ...
        pluginState.toggleOrderedList(editorView);
        expect(editorView.state.doc).toEqualDocument(doc(p('One'), p('Two'), p(), p('Three')));
      });
      ...
      it('should untoggle all list items with different ancestors in selection', () => {
        ...
        pluginState.toggleOrderedList(editorView);
        expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('One'))), p('Two'), p('Three'), p('One'), ol(li(p('Two')))));
      });
    });
    ...
    describe('joining lists', () => {
      ...
      it('should not join with previous list if it\'s not of the same type', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(
          doc(ol(li(p('One')), li(p('Two')), li(p('Three'))), ul(li(p('Four')), li(p('Five'))), p('Six'))
        );
      });
      ...
      it('should not join with next list if it isn\'t of the same type', () => {
        ...
        pluginState.toggleBulletList(editorView);
        expect(editorView.state.doc).toEqualDocument(
          doc(p('One'), ul(li(p('Two')), li(p('Three'))), ol(li(p('Four')), li(p('Five')), li(p('Six'))))
        );
      });
      ...
      it('should join with previous and next list if they\'re of the same type', () => {
        ...
        pluginState.toggleOrderedList(editorView);
        expect(editorView.state.doc).toEqualDocument(expectedOutputForPreviousAndNextList);
      });
      ...
      it('should not join with previous and next list if they\'re not of the same type', () => {
        ...
        pluginState.toggleBulletList(editorView);
        expect(editorView.state.doc).toEqualDocument(
          doc(ol(li(p('One')), li(p('Two'))), ul(li(p('Three')), li(p('Four'))), ol(li(p('Five')), li(p('Six'))))
        );
      });
    ...
    describe('Nested Lists', () => {
      ...
      it('should nest the list item when Tab key press', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('text'), ol(li(p('te{<>}xt')))), li(p('text')))));
      });
      ...
      it('should lift the list item when Shift-Tab key press', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('text')), li(p('te{<>}xt')), li(p('text')))));
      });
      ...
      it('should lift the list item when Enter key press is done on empty list-item', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('text')), li(p('{<>}')), li(p('text')))));
      });
    });
    ...
    describe('Enter key-press', () => {
      ...
      describe('when Enter key is pressed on non-empty nested list item', () => {
        it('should created new nested list item', () => {
          ...
          expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('text'), ol(li(p('test')), li(p('{<>}')))), li(p('text')))));
        });
      });
      ...
      describe('when Enter key is pressed on non-empty top level list item', () => {
        it('should created new list item at top level', () => {
          ...
          expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('text')), li(p('test')), li(p('{<>}')), li(p('text')))));
        });
      });
      ...
      describe('when Enter key is pressed on non-empty top level list item inside panel', () => {
        it('should created new list item at top level', () => {
          ...
          expect(editorView.state.doc).toEqualDocument(doc(panel(ol(li(p('text')), li(p('test')), li(p('{<>}')), li(p('text'))))));
        });
      });
      ...
      describe('when Enter key is pressed on empty top level list item', () => {
        it('should create new paragraph outside the list', () => {
          ...
          expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('text'))), p('{<>}'), ol(li(p('text')))));
        });
      });
      ...
      describe('when Enter key is pressed on empty top level list item inside panel', () => {
        it('should create new paragraph outside the list', () => {
          ...
          expect(editorView.state.doc).toEqualDocument(doc(panel(ol(li(p('text'))), p('{<>}'), ol(li(p('text'))))));
        });
      });
    });
    ...
    describe('Toggle - nested list scenarios - to lift items out of list', () => {
      ...
      it('should be possible to toggle a simple nested list', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('text'))), p('text{<>}'), ol(li(p('text')))));
      });
      ...
      it('should be possible to toggle a selection across different depths in the list', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(p('te{<}xt'), p('text{>}'), ol(li(p('text')))));
      });
      ...
      it('should be possible to toggle a selection across lists with different parent lists', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(p('te{<}xt'), p('text'), p('te{>}xt'), ol(li(p('text')))));
      });
      ...
      it('should be create a new list for children of lifted list item', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(doc(ol(li(p('text'))), p('te{<>}xt'), ol(li(p('text')), li(p('text')))));
      });
      ...
      it('should only change type to bullet list when toggling orderedList to bulletList', () => {
        ...
        expect(editorView.state.doc).toEqualDocument(
          doc(ol(li(p('text'), ol(li(p('text'), ul(li(p('te{<>}xt')))))), li(p('text'))))
        );
      });
    });
