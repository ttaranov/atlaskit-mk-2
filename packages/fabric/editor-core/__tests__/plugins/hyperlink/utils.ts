...
describe('hyperlink', () => {
  ...
  describe('getLinkMatch', () => {
    ...
    it('should match only the link when surrounded with text', () => {
      ...
      expect(getLinkMatch(noise('http://www.atlassian.com'))!.raw).toEqual('http://www.atlassian.com');
      expect(getLinkMatch(noise('http://www.atlassian.com/'))!.raw).toEqual('http://www.atlassian.com/');
      ...
      expect(getLinkMatch(noise('www.atlassian.com/'))!.raw).toEqual('www.atlassian.com/');
      expect(getLinkMatch(noise('www.atlassian.com/foo/bar'))!.raw).toEqual('www.atlassian.com/foo/bar');
      expect(getLinkMatch(noise('www.atlassian.com:12313/foo/bar'))!.raw).toEqual('www.atlassian.com:12313/foo/bar');
      expect(getLinkMatch(noise('www.atlassian.com/foo/bar#foo'))!.raw).toEqual('www.atlassian.com/foo/bar#foo');
      expect(getLinkMatch(noise('www.atlassian.com/foo/bar?foo#bar'))!.raw).toEqual('www.atlassian.com/foo/bar?foo#bar');
    });
    ...
    it('should not match special characters', () => {
      expect(getLinkMatch('[www.atlassian.com?hello=there]')!.raw).toEqual('www.atlassian.com?hello=there');
      expect(getLinkMatch('(www.atlassian.com#hello>')!.raw).toEqual('www.atlassian.com#hello');
      expect(getLinkMatch('(www.atlassian.com/hello<')!.raw).toEqual('www.atlassian.com/hello');
      expect(getLinkMatch('(www.atlassian.com/hello?foo=bar^)')!.raw).toEqual('www.atlassian.com/hello?foo=bar^');
    });
    ...
    it('should match only the EMAIL when surrounded with text', () => {
      expect(getLinkMatch(noise('http://localhost:1988'))!.raw).toEqual('http://localhost:1988');
      expect(getLinkMatch(noise('prettyandsimple@example.com'))!.raw).toEqual('prettyandsimple@example.com');
      expect(getLinkMatch(noise('very.common@example.com'))!.raw).toEqual('very.common@example.com');
      expect(getLinkMatch(noise('disposable.style.email.with+symbol@example.com'))!.raw).toEqual('disposable.style.email.with+symbol@example.com');
      expect(getLinkMatch(noise('other.email-with-dash@example.com'))!.raw).toEqual('other.email-with-dash@example.com');
      expect(getLinkMatch(noise('x@example.com'))!.raw).toEqual('x@example.com');
      expect(getLinkMatch(noise('example-indeed@strange-example.com'))!.raw).toEqual('example-indeed@strange-example.com');
    });
