...
import { doc, p, decisionList, decisionItem, defaultSchema as schema } from '@atlaskit/editor-test-helpers';
  ...
  describe('Utils -> Document', () => {
    ...
    describe('preprocessDoc', () => {
      it('should return true if node is empty', () => {
        ...
        expect((processedContent as Node)!.content!.firstChild!.type.name).toEqual('paragraph');
      });
