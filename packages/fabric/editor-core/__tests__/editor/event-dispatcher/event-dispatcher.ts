    ...
    describe('EventDispatcher', () => {
      describe('#on', () => {
        it('should add event listener', () => {
          ...
          expect(Object.keys(eventDispatcher.listeners).length).toEqual(1); expect(eventDispatcher.listeners['event'].length).toEqual(1);
        });
      });
      ...
      describe('#emit', () => {
        it('should call listener once with provided data', () => {
          ...
          expect(listener.calledWithExactly(data)).toBe(true);
        });
      });
    });
