 ...
 */
export default function spyOnReturnValue(object: any, methodName: string, sandbox?: typeof jest) {
  ...
  spy.mockImplementation((...args) => spy.returnValue = originalFn.apply(object, args));
