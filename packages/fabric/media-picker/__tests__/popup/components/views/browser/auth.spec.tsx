...
import { startAuth } from '../../../../../src/popup/actions';
import { ServiceAccountLink } from '../../../../../src/popup/domain';
import { mockState, mockStore } from '../../../mocks';
import {
  StatelessAuth,
  default as ConnectedAuth,
} from '../../../../../src/popup/components/views/browser/auth/auth';
