import AkButton, { Props as AkButtonProps } from '@atlaskit/button';
...
import {
  FolderViewer,
  FolderViewerProps,
} from '../../../../../src/popup/components/views/browser/folderView/folderView';
...
describe('<FolderViewr />', () => {
  ...
  it('should render loading button given folder is loading', () => {
    ...
    const buttons = wrapper.find<AkButtonProps & { children?: ReactNode }>(
      AkButton,
    );
