...
const NavButton = styled<ButtonProps>(Button)`
  display: block;
  padding: 0 8px;
  background: none;
...
export const ControlButton = styled(NavButton)``;
...
export const AccountItemButton = styled(NavButton)``;
...
export const AccountDropdownWrapper = styled.div`
  ...
  ._2bHmKR7knCi29wMEu4Z-2r > div > div:last-child {
