...
export const standardServiceEmojis: EmojiServiceResponse =
  emoji.sampleEmojiData.standardServiceEmojis;
export const atlassianServiceEmojis: EmojiServiceResponse =
  emoji.sampleEmojiData.atlassianServiceEmojis;
