...
export const standardServiceEmojis: EmojiServiceResponse = emoji.sampleEmojiData
  .standardServiceEmojis as EmojiServiceResponse;
export const atlassianServiceEmojis: EmojiServiceResponse = emoji
  .sampleEmojiData.atlassianServiceEmojis as EmojiServiceResponse;
