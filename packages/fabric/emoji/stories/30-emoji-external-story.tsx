...
} from './demo-resourced-emoji-list';
...
const atlassianEmojiMigrationProvider = Promise.resolve(
  new AtlassianEmojiMigrationResource(emojiConfig),
);
...
storiesOf(`${name}/external-emoji`, module)
  .add('resourced picker', () => {
    ...
    return (
      <ResourcedEmojiControl emojiConfig={emojiConfig} children={picker} />
    );
  })
  ...
  .add('resourced typeahead', () => {
    ...
    return (
      <ResourcedEmojiControl emojiConfig={emojiConfig} children={typeAhead} />
    );
  })
  .add('resource emoji', () => {
    ...
    return (
      <ResourcedEmojiControl emojiConfig={emojiConfig} children={emojiList} />
    );
  })
  ...
  .add('resource emoji - by id', () => {
    const emojiById = (
      <ResourcedEmojiById emojiProvider={defaultEmojiProvider} />
    );
    return (
      <div>
        <ResourcedEmojiControl emojiConfig={emojiConfig} children={emojiById} />
      </div>
    );
  });
