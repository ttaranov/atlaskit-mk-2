...
storiesOf(`${name}/MentionPicker-external`, module)
  ...
  .add(
    'Input field mention list. Real API, with productIdentifier and cloudId. Key binding',
    () => (
      <ConfigurableMentionPicker config={sessionServiceConfig}>
        <MentionTextInput
          label="User search"
          onSelection={action('mention selected')}
        />
  ...
  .add(
    'Input field mention list. Real API, but expecting an Atlassian Id Cookie for authentication and authorisation',
    () => (
