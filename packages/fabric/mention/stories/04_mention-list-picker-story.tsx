...
storiesOf(`${name}/MentionPicker`, module)
  ...
  .add(
    'Input field mention list. Mock API with info-hints. Key binding',
    () => (
      <MentionTextInput
        label="User search"
        onSelection={action('mention selected')}
  ...
  .add(
    'Input field at bottom mention list. Mock API. Mocked presence (slow)',
    () => (
      <div style={bottomStyle}>
        <MentionTextInput
          label="User search"
