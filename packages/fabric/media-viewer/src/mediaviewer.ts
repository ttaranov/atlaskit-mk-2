...
export interface MediaViewerInterface {
  ...
  on(
    eventName: 'fv.changeMode',
    callback: (mode: MediaViewerMode) => void,
    context?: any,
  ): void;
  on(eventName: 'fv.updateFiles', callback: () => void, context?: any): void;
  on(
    eventName: 'fv.changeFile',
    callback: (file: MediaFileAttributes) => void,
    context?: any,
  ): void;
  on(
    eventName: 'fv.showFile',
    callback: (file: MediaFileAttributes) => void,
    context?: any,
  ): void;
  on(
    eventName: 'fv.showFileError',
    callback: (file: MediaFileAttributes) => void,
    context?: any,
  ): void;
