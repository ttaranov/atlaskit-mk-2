...
> {
  ...
  componentWillMount() {
    ...
    './cardViewInternal').then(module => module.CardViewBase);
  }
...
export const CardView = (Loadable as any)({
  loader: () =>
    ...
    './cardViewInternal').then(module => module.CardView),
  loading: () => <CardLoading />,
});
...
export const CardViewWithAnalyticsEvents = (Loadable as any)({
  loader: () =>
    ...
    './cardViewInternal').then(module => module.CardViewWithAnalyticsEvents),
  loading: () => <CardLoading />,
});
