...
import { AppCardView, AppCardModel } from '../../../../app_2/AppCardViewV2';
...
function convertModel(model: AppCardModel) {
  ...
  return element.find(BlockCardView).props();
}
...
describe('AppCardViewV2', () => {
  it('should not render the old design by default', () => {
    ...
    expect(element.find(BlockCardView)).toHaveLength(0);
  });
  ...
  it('should render the new design when newDesign=true', () => {
    ...
    expect(element.find(BlockCardView)).toHaveLength(1);
  });
