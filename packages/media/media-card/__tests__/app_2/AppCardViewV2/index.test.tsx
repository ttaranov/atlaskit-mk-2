...
import { CardView } from '@atlaskit/smart-card';
...
function convertModel(model: AppCardModel) {
  ...
  return element.find(CardView).props();
}
...
describe('AppCardViewV2', () => {
  it('should not render the old design by default', () => {
    ...
    expect(element.find(CardView)).toHaveLength(0);
  });
  ...
  it('should render the new design when newDesign=true', () => {
    ...
    expect(element.find(CardView)).toHaveLength(1);
  });
