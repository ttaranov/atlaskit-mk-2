...
import { InlineCardView } from '../../src/InlineCardView/index';
import { A, Text, Img } from '../../src/InlineCardView/styled';

describe('InlineCardView', () => {
  it('should render anchor', () => {
    const link = { href: 'some-href', title: 'some-anchor-title' };
    const element = shallow(
      <InlineCardView link={link} text="some text content" />,
    );
  ...
  it('should render icon when it is provided', () => {
    ...
    const element = shallow(
      <InlineCardView link={link} text="some text content" icon={icon} />,
    );
  ...
  it('should render lozenge when it is provided', () => {
    ...
    const element = shallow(
      <InlineCardView link={link} text="some text content" lozenge={lozenge} />,
    );
