...
const svg = (iconGradientStart: string, iconGradientStop: string) => {
  ...
  <svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" focusable="false" aria-hidden="true">
    <defs>
      <linearGradient x1="104.953%" y1="21.894%" x2="46.569%" y2="75.208%" id="${id}">
    ...
    <g stroke="none" stroke-width="1" fill-rule="nonzero">
      <path d="M27.3886833,12.3958093 L20.0320674,12.3958093 L18.7974728,19.5995707 L13.7023207,19.5995707 L7.68612174,26.7445417 C7.87680866,26.9094297 8.11992598,27.0011197 8.37200761,27.0032187 L24.3394307,27.0032187 C24.727754,27.0082167 25.0611955,26.7281258 25.1233002,26.3447683 L27.3886833,12.3958093 Z" fill="url(#${id})"></path>
