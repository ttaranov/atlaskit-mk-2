...
const ApprovedCircle = props => (
  <circle
    className={css({
      fill: themed({ light: colors.G400, dark: colors.G300 })(props),
    })}
    {...props}
  />
);

const ApprovedPath = props => (
  <path
    className={css({
...
const DeclinedCircle = props => (
  <circle
    className={css({
      fill: themed({ light: colors.R400, dark: colors.R300 })(props),
    })}
    {...props}
  />
);

const DeclinedPath = props => (
  <path
    className={css({
      fill: colors.background(props),
    })}
...
const LockedCircle = props => (
  <circle
    className={css({
      fill: themed({ light: colors.N40, dark: colors.DN800 })(props),
    })}
    {...props}
  />
);

const LockedPath = props => (
  <path
    className={css({
      fill: themed({ light: colors.N500, dark: colors.DN30 })(props),
    })}
    {...props}
  />
);

export default function getStatusSvg(status: string, theme) {
  switch (status) {
    case 'approved':
      return (
        <Svg>
          <ApprovedCircle theme={theme} cx="4" cy="4" r="4" />
          <ApprovedPath
            theme={theme}
    ...
    case 'declined':
      return (
        <Svg>
          <DeclinedCircle theme={theme} cx="4" cy="4" r="4" />
          <DeclinedPath
            theme={theme}
    ...
    case 'locked':
      return (
        <Svg>
          <LockedCircle theme={theme} cx="4" cy="4" r="4" />
          <LockedPath
            theme={theme}
