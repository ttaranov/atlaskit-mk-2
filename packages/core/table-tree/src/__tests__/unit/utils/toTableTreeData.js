...
test('to throw exception if root items do not have key property', () => {
  const rootData = [
  ...
  }).toThrowError(/No property 'key' found in rootItem\[0\]/);
});

test('to throw exception if parent item does not have key property', () => {
  ...
  expect(() => {
    tableTreeDataHelper.updateItems(childItem, [], ...parentItem);
  }).toThrowError(/No property 'author' found in parent item/);
});

test('to throw exception if root items do not have key property when appending', () => {
  const rootData = [
    { title: 'Chapter One', page: 10, id: 1 },
    { title: 'Chapter Two', page: 20, id: 2 },
    { title: 'Chapter Three', page: 30, id: 3 },
...
test('to throw exception if parent item does not have key property when appending', () => {
  const parentItem = [{ title: 'Chapter One', page: 10, id: 1 }];
  const childItem = [{ title: 'Chapter Two', page: 20, id: 2 }];
  const tableTreeDataHelper = new TableTreeDataHelper({ key: 'author' });
  expect(() => {
...
test('to return rootIds and itemsById for root items with defaults when appending', () => {
  const rootData = [
    { title: 'Chapter One', page: 10, key: 1 },
    { title: 'Chapter Two', page: 20, key: 2 },
    { title: 'Chapter Three', page: 30, key: 3 },
...
test('to update the root items when appending', () => {
...
test('to update the parent item with child ids when appending', () => {
  const parentItem = [{ title: 'Chapter One', page: 10, id: 1 }];
  const childItem = [{ title: 'Chapter Two', page: 20, id: 2 }];
  const tableTreeDataHelperInstance = new TableTreeDataHelper({ key: 'id' });
...
test('to append the parent item with child ids when appending', () => {
  const parentItem = [{ title: 'Chapter One', page: 10, id: 1 }];
  const childItem = [{ title: 'Chapter Two', page: 20, id: 2 }];
