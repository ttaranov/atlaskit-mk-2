...
export const backgroundActive = themed({ light: B50, dark: DN40 });
export const backgroundHover = themed({ light: N30, dark: DN50 });
...
export const textActive = themed({ light: N800, dark: DN600 });
