...
describe('Reducers', () => {
  ...
  describe('Create Conversation', () => {
    it('should optimistically add a conversation to state on REQUEST', () => {
      ...
      const [comment] = (mockConversation: any).comments;
      ...
      expect(store.getState()).toEqual({
        conversations: [
          mockConversation,
          {
            ...
            comments: [
              {
                ...(mockInlineConversation: any).comments[0],
                state: 'ERROR',
                error: err,
                isPlaceholder: true,
                oldDocument: (mockInlineConversation: any).comments[0].document,
              },
            ],
          },
        ],
  ...
  describe('Update Comment', () => {
    it('should optimistically update the comment on REQUEST', () => {
      ...
      const [firstComment, ...otherComments] = (mockConversation: any).comments;
