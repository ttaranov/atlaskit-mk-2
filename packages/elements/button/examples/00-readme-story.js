...
const buttonPropDescriptions = {
  appearance:
    "Predefined appearances of an ak-button. One of: 'primary', 'default', 'subtle', 'compact', 'subtle-link', 'help'",
...
storiesOf(name, module).add('📖 Button readme', () => (
  <div>
    <Readme component={name} description={description}>
      <Code code={ButtonOverviewExampleRaw}>{ButtonOverviewExample}</Code>
