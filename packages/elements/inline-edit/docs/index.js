...
export const description = (
  <div>
    <p>
      ...
      to control an input component such as{' '}
      <Link to="/components/input">@atlaskit/input</Link> field.
    </p>
    <p>
      The package exports a stateful (default) and stateless version of{' '}
      <code>InlineEdit</code>:
    </p>
    <Usage>
    ...
    <p>
      ...
      <code>onCancel</code> and <code>onConfirm</code> handlers. All other props
      passed to the <code>InlineEditor</code> component are passed directly
      through to the stateless <code>InlineEdit</code> component.
    </p>
  </div>
);
