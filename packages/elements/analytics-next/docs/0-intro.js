...
`}
  ...
  * [Adding extra information to an analytics event](/mk-2/packages/elements/analytics-next/docs/concepts#adding-more-information-to-an-event)
  * [Analytics component reference](/mk-2/packages/elements/analytics-next/docs/reference)
    ...
    <InstrumentedTable
      packages={[
        ...
        },
        {
          ...
          component: 'Comment',
          context: { component: 'comment' },
        },
        {
          packageName: '@atlaskit/comment',
          component: 'CommentAction',
          context: { component: 'comment-action' },
          prop: 'onClick',
          payload: { action: 'click' },
        },
        {
        ...
        },
        {
          ...
          context: { component: 'comment-action' },
          prop: 'onMouseOver',
          payload: { action: 'mouseover' },
        },
        {
          packageName: '@atlaskit/comment',
          component: 'CommentAuthor',
          context: { component: 'comment-author' },
          prop: 'onClick',
          payload: { action: 'click' },
        },
        {
        ...
        },
        {
          ...
          context: { component: 'comment-edited' },
          prop: 'onClick',
          payload: { action: 'click' },
        },
        {
        ...
        },
        {
          ...
          context: { component: 'comment-time' },
          prop: 'onClick',
          payload: { action: 'click' },
        },
        {
