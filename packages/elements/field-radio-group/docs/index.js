...
export const description = (
  <div>
    <p>
      Radio group exports a stateful component as the default export. This
      handles the selection of items for you. You can also import a stateless
      version as <code>AkFieldRadioGroup</code>.
    </p>
    <Usage>
      {
    ...
    <p>
      ...
      <code>akRadio</code> component to render. Both stateful and stateless
