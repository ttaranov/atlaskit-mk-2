...
const PickerTestComponent = (props: Object) => <div {...props} />;
  ...
  describe('Picker', () => {
    ...
    it('does not render the icon if shouldShowIcon is false', () => {
      const wrapper = shallow(
        <Picker {...components} shouldShowIcon={false} />,
      );
    ...
    it('calls onIconClick on icon MouseDown event', () => {
      ...
      const wrapper = shallow(
        <Picker {...components} shouldShowIcon onIconClick={onIconClickMock} />,
      );
    ...
    it('calls onFieldBlur when the field is blurred', () => {
      ...
      const wrapper = shallow(
        <Picker {...components} onFieldBlur={onFieldBlurMock} />,
      );

      wrapper
        .find(PickerTestComponent)
        .at(1)
        .props()
        .onBlur();
    ...
    it('calls onFieldChange when the field is changed', () => {
      ...
      const wrapper = shallow(
        <Picker {...components} onFieldChange={onFieldChangeMock} />,
      );
    ...
    it('calls onFieldTriggerOpen when the field triggers a dialog open', () => {
      ...
      const wrapper = shallow(
        <Picker {...components} onFieldTriggerOpen={onFieldTriggerOpenMock} />,
      );
    ...
    it('calls onPickerBlur when the picker is blurred', () => {
      ...
      const wrapper = shallow(
        <Picker {...components} onPickerBlur={onPickerBlurMock} />,
      );
    ...
    it('calls onPickerTriggerClose when the picker triggers a dialog close', () => {
      ...
      const wrapper = shallow(
        <Picker
          {...components}
          onPickerTriggerClose={onPickerTriggerCloseMock}
        />,
      );
    ...
    it('calls onPickerUpdate when the picker is updated', () => {
      ...
      const wrapper = shallow(
        <Picker {...components} onPickerUpdate={onPickerUpdateMock} />,
      );
