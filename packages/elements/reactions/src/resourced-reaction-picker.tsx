...
export default class ResourcedReactionPicker extends PureComponent<
  Props,
  State
> {
  ...
  private refreshReactions(
    reactionsProviderPromise: Promise<ReactionsProvider>,
  ) {
  ...
  private handleReactionPickerSelection = emojiId => {
    const { containerAri, ari, itemCreationDate } = this.props;
