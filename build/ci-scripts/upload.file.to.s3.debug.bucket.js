...
const BUCKET_NAME = 'atlaskit-debug-files';
const BUCKET_REGION = 'ap-southeast-2';

if (!AWS_ACCESS_KEY || !AWS_SECRET_KEY) {
  console.error('AWS_ACCESS_KEY or AWS_SECRET_KEY are missing');
...
npmRun.sync(
  `s3-cli --region="${BUCKET_REGION}" put ${pathToFile} s3://${BUCKET_NAME}/${fileName}`,
);
