...
```
# Deploy staging (prod)
docker build -t docker.atl-paas.net/atlaskit/atlaskid:v5 . && docker push docker.atl-paas.net/atlaskit/atlaskid:v5 && micros service:deploy atlaskit-atlaskid -e stg-west
```
