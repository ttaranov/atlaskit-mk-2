...
const contexts = {
  'editor-core': require.context(
    '../../packages/editor/editor-core/src/__tests-karma__/',
    true,
    /^[^_]*.(js|jsx|ts|tsx)$/,
  ),
  'editor-test-helpers': require.context(
    '../../packages/editor/editor-test-helpers/src/__tests-karma__/',
    true,
    /^[^_]*.(js|jsx|ts|tsx)$/,
  ),
  'editor-common': require.context(
    '../../packages/editor/editor-common/src/__tests-karma__/',
    true,
    /^[^_]*.(js|jsx|ts|tsx)$/,
  ),
  'editor-confluence-transformer': require.context(
    '../../packages/editor/editor-confluence-transformer/src/__tests-karma__/',
    true,
    /^[^_]*.(js|jsx|ts|tsx)$/,
  ),
  'editor-mobile-bridge': require.context(
    '../../packages/editor/editor-mobile-bridge/src/__tests-karma__/',
    true,
    /^[^_]*.(js|jsx|ts|tsx)$/,
  ),
};
