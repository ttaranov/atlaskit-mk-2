...
function matchesRequest(req) {
  return [
    ...
    function(req) {
      return (
        req.url().path === '/upload/9b3f471f-9a21-4d13-88ff-23d2d8c80397/chunks'
      );
    },
...
responseArray.push(
  /**
   * PUT /upload/9b3f471f-9a21-4d13-88ff-23d2d8c80397/chunks
   *
  ...
  function(req, res) {
    ...
    res.header('x-b3-spanid', 'd7d70a1137c0ea12');
    res.header('x-b3-traceid', 'd7d70a1137c0ea12');
